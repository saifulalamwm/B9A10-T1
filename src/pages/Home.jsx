...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="w-11/12 m-auto grid lg:grid-cols-2 grid-cols-1 m-14 bg-gradient-to-r from-indigo-400 to-cyan-400 ">
        <div className="mt-10  text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <img src="https://i.ibb.co/hRwXwZV/india2.jpg" alt="" />
          <img src="https://i.ibb.co/Xb1t9TZ/china.jpg" alt="" />
          <img src="https://i.ibb.co/hRwXwZV/india2.jpg" alt="" />
          <img src="https://i.ibb.co/Xb1t9TZ/china.jpg" alt="" />
        </div>
      </div>
