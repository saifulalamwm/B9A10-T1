...
const Spots = () => {
  ...
  const uniqueZones = [...new Set(loadedSpots.map((spot) => spot.zone))];

  const handleZoneClick = (zone) => {
    setSelectedZone(zone);
    setSpots(loadedSpots.filter((spot) => spot.zone === zone));
  };
  ...
  return (
    <div className="w-11/12 m-auto my-10">
      ...
      <div className="flex  gap-5 my-5 items-center">
        <p className="font-bold bg-cyan-600 text-white p-1 w-20 rounded-lg text-center">
          Zone :{" "}
        </p>
